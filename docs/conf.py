...
version = ".".join(map(str, aioopenssl.version_info[:2]))
# The full version, including alpha/beta/rc tags.
release = aioopenssl.__version__
...
htmlhelp_basename = 'aioopenssldoc'
...
latex_documents = [
  ('index', 'aioopenssl.tex', 'aioopenssl Documentation',
...
man_pages = [
    ('index', 'aioopenssl', 'aioopenssl Documentation',
     ['Jonas Wielicki'], 1)
]
...
texinfo_documents = [
  ('index', 'aioopenssl', 'aioopenssl Documentation',
   'Jonas Wielicki', 'aioopenssl', 'One line description of project.',
   'Miscellaneous'),
]
